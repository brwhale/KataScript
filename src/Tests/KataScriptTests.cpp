...
public:
	...
	TEST_METHOD(AssignNull) {
		...
		Assert::AreEqual(KataScript::KSType::Null, value->type);
	...
	TEST_METHOD(FunctionCreate) {
		...
		Assert::AreEqual(KataScript::KSType::Null, nonval->type);
    ...
    TEST_METHOD(ScopingViolationBugfix) {
        ...
        Assert::AreEqual(KataScript::KSType::Null, val->type);
    }
    ...
    TEST_METHOD(MakeClass) {
        ...
        auto val = interpreter.resolveVariable("a"s);
        Assert::AreEqual(KataScript::KSType::Class, val->type);
        Assert::AreEqual(KataScript::KSType::Int, val->getClass()->variables["x"]->type);
        Assert::AreEqual(KataScript::KSInt(4), val->getClass()->variables["x"]->getInt());
        Assert::AreEqual(KataScript::KSType::Float, val->getClass()->variables["y"]->type);
        Assert::AreEqual(KataScript::KSFloat(5.0), val->getClass()->variables["y"]->getFloat());
    }
    ...
    TEST_METHOD(MutateClass) {
        ...
        Assert::AreEqual(KataScript::KSType::Class, val->type);
        Assert::AreEqual(KataScript::KSType::Int, val->getClass()->variables["x"]->type);
        Assert::AreEqual(KataScript::KSInt(8), val->getClass()->variables["x"]->getInt());
        Assert::AreEqual(KataScript::KSType::Float, val->getClass()->variables["y"]->type);
        Assert::AreEqual(KataScript::KSFloat(10.0), val->getClass()->variables["y"]->getFloat());
    ...
    TEST_METHOD(CopyMutateClassLeaveOriginalAlone) {
        ...
        val = interpreter.resolveVariable("b"s);
        Assert::AreEqual(KataScript::KSType::Class, val->type);
        Assert::AreEqual(KataScript::KSType::String, val->getClass()->variables["x"]->type);
        Assert::AreEqual("4a"s, val->getClass()->variables["x"]->getString());
        Assert::AreEqual(KataScript::KSType::String, val->getClass()->variables["y"]->type);
